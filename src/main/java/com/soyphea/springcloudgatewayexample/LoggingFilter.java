...
@Slf4j
@Component
@ConditionalOnProperty(value = "app.logging.enabled", havingValue = "true")
public class LoggingFilter implements GlobalFilter, Ordered {
    ...
    private static class Logger {
        ...
        Logger(ServerHttpRequest request) {
            ...
            sb.append("Client ID:").append(request.getHeaders().getFirst("client_id"));
            sb.append("User ID:").append(request.getHeaders().getFirst("cif"));
            sb.append("Method:").append(request.getMethod()).append("\n");
            sb.append("Url:").append(request.getPath().value()).append("\n");
        }
